        ...
        <div class="APP_first_section">
            ...
            <div class="APP_fourth_section">
                ...
                <div class="APP_fourth_section_right">
                    ...
                    <img class="APP_fourth_section_right_icon" src="./assets/APP/2.png" />
                    <img class="APP_fourth_section_right_icon" src="./assets/APP/3.png" />
                    <img class="APP_fourth_section_right_icon" src="./assets/APP/4.png" />
                    <img class="APP_fourth_section_right_icon" src="./assets/APP/5.png" />
                    <img class="APP_fourth_section_right_icon" src="./assets/APP/6.png" />
                    <img class="APP_fourth_section_right_icon" src="./assets/APP/7.png" />
                    <img class="APP_fourth_section_right_icon" src="./assets/APP/8.png" />
                </div>
            </div>
